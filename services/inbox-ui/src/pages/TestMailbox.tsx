				...
				<ScrollArea className="flex-1">
					<TabsContent value="preview" className="p-0 mt-0 h-full">
						{log.html_body ? (
							...
							<pre className="p-6 text-sm font-mono whitespace-pre-wrap text-foreground">
								{log.text_body}
							</pre>
						) : (
					...
					<TabsContent value="source" className="p-0 mt-0">
						{log.html_body ? (
							<pre className="p-6 text-xs font-mono whitespace-pre-wrap text-foreground overflow-auto">
								{log.html_body}
							</pre>
						) : log.text_body ? (
							<pre className="p-6 text-xs font-mono whitespace-pre-wrap text-foreground overflow-auto">
