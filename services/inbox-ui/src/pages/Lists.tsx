    ...
    <div className="p-6">
      <div className="max-w-[680px]">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Lists attach one-click unsubscribe headers to sequence sends. A recipient who unsubscribes is suppressed globally.
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20 text-muted-foreground text-sm">No lists yet.</div>
        ) : (
