		...
		<Sidebar collapsible="none" className="border-r border-sidebar-border h-svh">
			...
			<SidebarHeader className="px-4 py-5 border-b border-sidebar-border">
				<div className="flex items-center gap-3">
					<AppLogo size={32} />
					<div>
						<p className="text-[14px] font-bold text-foreground tracking-tight leading-none">EmailFlare</p>
						<p className="text-[11px] text-muted-foreground mt-[5px] leading-none">Admin console</p>
					</div>
				</div>
			</SidebarHeader>
				...
				<div className="mb-1">
					...
					<SidebarMenu className="gap-0.5">
						<SidebarMenuItem>
							<SidebarMenuButton
								render={
									<a href="https://emailflare.dev/docs" target="_blank" rel="noopener noreferrer" />
								}
