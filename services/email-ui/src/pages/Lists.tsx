			...
			<div className="max-w-[680px]">
				<div className="flex items-center justify-between mb-6">
					<div>
						...
						<p className="text-sm text-muted-foreground mt-1">
							Attach one-click unsubscribe headers to sends. A recipient who unsubscribes is suppressed
							globally.
						</p>
					</div>
				...
				{loading ? (
					...
					<div className="text-center py-20 text-muted-foreground text-sm">
						No unsubscribe lists yet. Create one to enable one-click unsubscribe headers.
					</div>
				) : (
